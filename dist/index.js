...
class NativeCameraProxy {
    ...
    getLastFrame() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const parsedData = frameDataJSONString.data ? JSON.parse(frameDataJSONString.data) : frameDataJSONString;
            return parsedData;
        });
    }
    getLastFrameOrNull() {
